...
function CrudLuminosidade() {
    ...
    const handleCreate = async () => {
        ...
        console.log("Dados enviados:", newData); // Log dos dados
        try {
            await axios.post("http://127.0.0.1:8000/api/create/luminosidade/", newData, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
            alert("Dado de luminosidade criado com sucesso!");
            resetForm();
            fetchLuminosidadeData(); // Atualiza os dados após criar
        } catch (err) {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            const response = await axios.put(`http://127.0.0.1:8000/api/luminosidade/${editingId}/`, updatedData, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
            alert('Dado atualizado com sucesso');
            fetchLuminosidadeData(); // Atualiza os dados após a atualização
        } catch (error) {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://127.0.0.1:8000/api/luminosidade/${id}/`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
            alert("Dado de luminosidade excluído com sucesso!");
            fetchLuminosidadeData(); // Atualiza os dados após excluir
        } catch (err) {
    ...
    // Função para buscar dados de luminosidade (GET)
    const fetchLuminosidadeData = async () => {
        try {
            ...
            setLuminosidadeData(response.data);
        } catch (err) {
            console.error("Erro ao buscar dados de luminosidade:", err);
        ...
        <div style={styles.body}>
            ...
            <div style={styles.container}>
                ...
                <div style={styles.post}>
                    <h2>Criar Novo Dado de Luminosidade</h2>
                    <input
                        type="number"
                ...
                {editingId && (
                    <div style={styles.post}>
                        <h2>Atualizar Dado de Luminosidade</h2>
...
export default CrudLuminosidade;
